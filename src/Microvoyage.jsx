...
// ── Seeded trip reports ────────────────────────────────────────────────────
const SEED_REPORTS = [
  { id:"s1",  city:"Nashville, TN",    from:"Washington DC", days:1, groundH:12, verdict:"worth",  highlight:"Honky Tonk Highway at 2pm — no cover, live music everywhere, completely surreal on a Tuesday", report:"Left DCA at 6am, landed at 8. Grabbed hot chicken at Hattie B's by 10, walked Broadway for two hours, did a quick tour of the Ryman. Was back at the airport by 7pm with time to spare. The math works — you really do get a full day.", author:"Dyle", date:"Feb 2025" },
  { id:"s2",  city:"Nashville, TN",    from:"New York",      days:2, groundH:28, verdict:"worth",  highlight:"Watching the sunset from the rooftop of The Joseph hotel with a whiskey sour", report:"Two days is the sweet spot for Nashville. Day one we did all the touristy stuff — Broadway, hot chicken, Ryman. Day two we rented a car and drove to the Natchez Trace. Came back completely recharged.", author:"Marcus T.", date:"Jan 2025" },
  { id:"s3",  city:"Charleston, SC",   from:"Washington DC", days:1, groundH:13, verdict:"worth",  highlight:"Rainbow Row at golden hour — it looks exactly like the photos, somehow", report:"Charleston is made for a day trip. Everything is walkable. We did the market, walked Rainbow Row, had she-crab soup at Husk, and wandered White Point Garden. Flew home full and happy. Only complaint: wish we'd had one more hour.", author:"Priya R.", date:"Mar 2025" },
  { id:"s4",  city:"New Orleans, LA",  from:"Washington DC", days:2, groundH:26, verdict:"worth",  highlight:"Frenchmen Street at midnight — jazz pouring out of every door, no tourists", report:"Don't do New Orleans as a day trip. Two days is the minimum. We spent the first evening on Frenchmen Street (not Bourbon — trust me), second day we did the Garden District and a cemetery tour. Ate beignets three times. Zero regrets.", author:"Sam K.", date:"Dec 2024" },
  { id:"s5",  city:"New York City",    from:"Washington DC", days:1, groundH:11, verdict:"tight",  highlight:"Walking the High Line into Chelsea Market — did both in under 3 hours", report:"Totally doable but you have to be ruthless about time. Train is better than flying for this one — Penn to Penn, no airport nonsense. We tried to fit in too much and felt rushed by 6pm. Pick one neighborhood and own it instead of trying to do the whole city.", author:"Jen L.", date:"Nov 2024" },
  { id:"s6",  city:"Chicago, IL",      from:"Washington DC", days:2, groundH:30, verdict:"worth",  highlight:"Architecture boat tour on the river — best two hours I've spent in any city", report:"Two days in Chicago felt like a week's worth of good memories. The architecture tour alone is worth the flight. We stayed in the Loop, walked to Millennium Park, did the Art Institute for half a day, ate deep dish at Lou Malnati's. Flew home Sunday night already planning the next trip.", author:"David C.", date:"Oct 2024" },
  { id:"s7",  city:"Reykjavik",        from:"New York",      days:3, groundH:42, verdict:"worth",  highlight:"Golden Circle self-drive — Geysir, Gullfoss, and Þingvellir in one day for $60 in gas", report:"Three days in Iceland sounds crazy but it's actually perfect. Fly overnight, land at 6am, you essentially gain a day. We rented a car, did the Golden Circle, soaked in the Blue Lagoon, and saw the northern lights on the last night. The flight is long but the 'on the ground' math is genuinely favorable.", author:"Aisha M.", date:"Jan 2025" },
  { id:"s8",  city:"Montreal, QC",     from:"New York",      days:2, groundH:32, verdict:"worth",  highlight:"Saturday morning at Jean-Talon Market — cheese, bread, and maple everything", report:"Montreal punches way above its weight for a weekend trip. It feels like Europe but without the jet lag. Old Montreal is gorgeous, the food scene is absurdly good, and everyone switches to English seamlessly. Book a table at Joe Beef if you can.", author:"Carlos V.", date:"Sep 2024" },
  { id:"s9",  city:"Lisbon",           from:"New York",      days:3, groundH:38, verdict:"worth",  highlight:"Taking tram 28 through Alfama at dusk — €3 and the best view in the city", report:"Three days in Lisbon is a revelation. The flight is overnight so you land ready to go. We did Belém the first morning, Alfama in the evening, day two was Sintra (absolutely go to Sintra), day three we just wandered. Pastéis de nata count as breakfast.", author:"Nina F.", date:"Feb 2025" },
  { id:"s10", city:"Philadelphia",     from:"Washington DC", days:1, groundH:14, verdict:"worth",  highlight:"Reading Terminal Market on a Saturday morning — arrive hungry", report:"Honestly this should be everyone's first micro trip. 1.75 hours on Amtrak, you're in the middle of the city. We did the Liberty Bell (15 minutes, don't linger), Reading Terminal for an hour, walked through Old City, had a proper cheesesteak, and made the 6pm train back. Perfect day.", author:"Tom B.", date:"Mar 2025" },
];

// verdict labels
const VERDICT = {
  worth: { label:"Worth it",   color:"#1a3a2a", bg:"#e8f5ee", border:"#b8dfc8" },
  tight: { label:"It was tight", color:"#7a4a00", bg:"#fef5e7", border:"#f0d090" },
  skip:  { label:"Skip it",    color:"#7a1a1a", bg:"#fdecea", border:"#f0b0b0" },
};
...
export default function App() {
  ...
  const [reportForm, setReportForm] = useState(null); // city key when form is open
  const [reportDraft, setReportDraft] = useState({ from:"", days:1, groundH:"", verdict:"worth", highlight:"", report:"", author:"" });
          ...
          {region && (
            <div style={{ marginBottom:22 }}>
              <label style={{ display:"block", fontSize:10, letterSpacing:"0.22em", textTransform:"uppercase", color:SAGE, marginBottom:8, fontWeight:500 }}>
                Airports <span style={{ color:"#999", textTransform:"none", letterSpacing:0, fontSize:11, fontWeight:400 }}>(mix airports to fly out from one, return to another)</span>
              </label>
                ...
                <div key={trip.id} className="trip-card" style={{ background:"#fff", border:`1px solid ${RULE}`, borderLeft: idx===0 ? `4px solid ${FOREST}` : `1px solid ${RULE}`, marginBottom:16, overflow:"hidden" }}>
                    ...
                    <div style={{ position:"absolute", bottom:0, left:0, right:0, padding:"14px 18px", display:"flex", alignItems:"flex-end", justifyContent:"space-between" }}>
                      <div>
                        ...
                        <div style={{ fontSize:10, color:"rgba(255,255,255,0.5)", letterSpacing:"0.1em" }}>
                          ...
                          {trip.outbound.from !== trip.return.to && <span style={{ marginLeft:6, color:"rgba(255,255,255,0.4)" }}>different return airport</span>}
                        </div>
                      </div>
                  ...
                  {exp && (
                    <div style={{ borderTop:`1px solid ${RULE}`, padding:"24px 24px" }}>
                      ...
                      {(() => {
                        const cityReports = [
                          ...SEED_REPORTS.filter(r => r.city === trip.destination_city),
                          ...userReports.filter(r => r.city === trip.destination_city),
                        ];
                        const isSubmitting = reportForm === trip.destination_city;
                        return (
                          <div style={{ marginBottom:20 }}>
                            <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:12 }}>
                              <div style={{ fontSize:10, letterSpacing:"0.2em", textTransform:"uppercase", color:SAGE, fontWeight:500 }}>
                                From the Community {cityReports.length > 0 && <span style={{ color:"#bbb", fontWeight:400, textTransform:"none", letterSpacing:0, fontSize:11 }}>· {cityReports.length} report{cityReports.length !== 1 ? "s" : ""}</span>}
                              </div>
                              {!isSubmitting && (
                                <button onClick={() => { setReportForm(trip.destination_city); setReportDraft({ from:region||"", days, groundH:"", verdict:"worth", highlight:"", report:"", author:"" }); }}
                                  style={{ fontSize:10, color:FOREST, background:"transparent", border:`1px solid ${SAGE}`, padding:"4px 12px", cursor:"pointer", letterSpacing:"0.08em", textTransform:"uppercase" }}>
                                  + Add Yours
                                </button>
                              )}
                            </div>
                            ...
                            {/* Existing reports */}
                            {cityReports.length === 0 && !isSubmitting && (
                              <div style={{ padding:"18px", background:CREAM, border:`1px solid ${RULE}`, textAlign:"center" }}>
                                <div style={{ fontFamily:"'Playfair Display', serif", fontStyle:"italic", color:"#aaa", fontSize:14, marginBottom:6 }}>No reports yet for this destination.</div>
                                <div style={{ fontSize:11, color:"#bbb" }}>Be the first — tell us how it went.</div>
                              </div>
                            )}

                            {cityReports.map(r => {
                              const v = VERDICT[r.verdict] || VERDICT.worth;
                              return (
                                <div key={r.id} style={{ background:"#fff", border:`1px solid ${RULE}`, borderLeft:`3px solid ${v.color}`, padding:"14px 16px", marginBottom:8 }}>
                                  <div style={{ display:"flex", alignItems:"flex-start", justifyContent:"space-between", marginBottom:8, gap:10 }}>
                                    <div style={{ display:"flex", alignItems:"center", gap:8, flexWrap:"wrap" }}>
                                      <span style={{ fontSize:11, fontWeight:500, color:INK }}>{r.from} → {r.city.split(",")[0]}</span>
                                      <span style={{ fontSize:9, color:"#aaa" }}>·</span>
                                      <span style={{ fontSize:10, color:"#888" }}>{r.days === 1 ? "Day trip" : `${r.days} days`}</span>
                                      {r.groundH && <><span style={{ fontSize:9, color:"#aaa" }}>·</span><span style={{ fontSize:10, color:"#888" }}>got ~{r.groundH}h</span></>}
                                    </div>
                                    <span style={{ fontSize:9, padding:"3px 9px", background:v.bg, color:v.color, border:`1px solid ${v.border}`, letterSpacing:"0.08em", textTransform:"uppercase", whiteSpace:"nowrap", flexShrink:0 }}>{v.label}</span>
                                  </div>
                                  <p style={{ margin:"0 0 8px", fontSize:13, color:"#555", lineHeight:1.7, fontFamily:"'Playfair Display', serif", fontStyle:"italic" }}>"{r.report}"</p>
                                  {r.highlight && (
                                    <div style={{ fontSize:11, color:FOREST, marginBottom:8 }}>
                                      <span style={{ color:SAGE, marginRight:5 }}>★</span>{r.highlight}
                                    </div>
                                  )}
                                  <div style={{ fontSize:10, color:"#bbb" }}>— {r.author}{r.date ? `, ${r.date}` : ""}</div>
                                </div>
                              );
                            })}
                            ...
                            {/* Submission form */}
                            {isSubmitting && (
                              <div style={{ background:CREAM, border:`1px solid ${RULE}`, borderTop:`3px solid ${FOREST}`, padding:"18px 16px", marginTop:8 }}>
                                <div style={{ fontSize:10, letterSpacing:"0.2em", textTransform:"uppercase", color:FOREST, fontWeight:500, marginBottom:14 }}>Share Your Trip</div>

                                <div style={{ display:"flex", gap:10, flexWrap:"wrap", marginBottom:12 }}>
                                  <div style={{ flex:"1 1 140px" }}>
                                    <label style={{ display:"block", fontSize:9, letterSpacing:"0.15em", textTransform:"uppercase", color:SAGE, marginBottom:5 }}>Flying from</label>
                                    <input value={reportDraft.from} onChange={e => setReportDraft(p => ({...p, from:e.target.value}))} placeholder="e.g. Washington DC"
                                      style={{ width:"100%", border:`1px solid ${RULE}`, background:"#fff", padding:"8px 10px", fontSize:12, outline:"none", fontFamily:"inherit" }} />
                                  </div>
                                  <div style={{ flex:"0 0 100px" }}>
                                    <label style={{ display:"block", fontSize:9, letterSpacing:"0.15em", textTransform:"uppercase", color:SAGE, marginBottom:5 }}>Trip length</label>
                                    <select value={reportDraft.days} onChange={e => setReportDraft(p => ({...p, days:Number(e.target.value)}))}
                                      style={{ width:"100%", border:`1px solid ${RULE}`, background:"#fff", padding:"8px 10px", fontSize:12, outline:"none", fontFamily:"inherit", appearance:"none" }}>
                                  ...
                                  <div style={{ flex:"0 0 90px" }}>
                                    <label style={{ display:"block", fontSize:9, letterSpacing:"0.15em", textTransform:"uppercase", color:SAGE, marginBottom:5 }}>Hours you got</label>
                                    <input type="number" value={reportDraft.groundH} onChange={e => setReportDraft(p => ({...p, groundH:e.target.value}))} placeholder="e.g. 12"
                                      style={{ width:"100%", border:`1px solid ${RULE}`, background:"#fff", padding:"8px 10px", fontSize:12, outline:"none", fontFamily:"inherit" }} />
                                  </div>
                                </div>

                                <div style={{ marginBottom:12 }}>
                                  <label style={{ display:"block", fontSize:9, letterSpacing:"0.15em", textTransform:"uppercase", color:SAGE, marginBottom:8 }}>Was it worth it?</label>
                                  <div style={{ display:"flex", gap:8 }}>
                                    {Object.entries(VERDICT).map(([key, v]) => (
                                      <button key={key} onClick={() => setReportDraft(p => ({...p, verdict:key}))}
                                        style={{ flex:1, padding:"8px 4px", border:`1px solid ${reportDraft.verdict===key ? v.color : RULE}`, background: reportDraft.verdict===key ? v.bg : "#fff", color: reportDraft.verdict===key ? v.color : "#aaa", cursor:"pointer", fontSize:11, transition:"all 0.15s", letterSpacing:"0.04em" }}>
                                        {v.label}
                                      </button>
                                    ))}
                                  </div>
                                ...
                                <div style={{ marginBottom:12 }}>
                                  <label style={{ display:"block", fontSize:9, letterSpacing:"0.15em", textTransform:"uppercase", color:SAGE, marginBottom:5 }}>Your story <span style={{ color:"#bbb", textTransform:"none", letterSpacing:0 }}>(what did you actually do?)</span></label>
                                  <textarea value={reportDraft.report} onChange={e => setReportDraft(p => ({...p, report:e.target.value}))} rows={3}
                                    placeholder="We landed at 8am and headed straight to..."
                                    style={{ width:"100%", border:`1px solid ${RULE}`, background:"#fff", padding:"9px 10px", fontSize:13, outline:"none", fontFamily:"'Playfair Display', serif", fontStyle:"italic", lineHeight:1.6, resize:"vertical" }} />
                                </div>

                                <div style={{ marginBottom:12 }}>
                                  <label style={{ display:"block", fontSize:9, letterSpacing:"0.15em", textTransform:"uppercase", color:SAGE, marginBottom:5 }}>Best thing you did <span style={{ color:"#bbb", textTransform:"none", letterSpacing:0 }}>(optional)</span></label>
                                  <input value={reportDraft.highlight} onChange={e => setReportDraft(p => ({...p, highlight:e.target.value}))} placeholder="e.g. Jazz on Frenchmen Street at midnight"
                                    style={{ width:"100%", border:`1px solid ${RULE}`, background:"#fff", padding:"8px 10px", fontSize:12, outline:"none", fontFamily:"inherit" }} />
                                </div>

                                <div style={{ marginBottom:16 }}>
                                  <label style={{ display:"block", fontSize:9, letterSpacing:"0.15em", textTransform:"uppercase", color:SAGE, marginBottom:5 }}>Your name <span style={{ color:"#bbb", textTransform:"none", letterSpacing:0 }}>(or leave blank)</span></label>
                                  <input value={reportDraft.author} onChange={e => setReportDraft(p => ({...p, author:e.target.value}))} placeholder="First name or nickname"
                                    style={{ width:"200px", border:`1px solid ${RULE}`, background:"#fff", padding:"8px 10px", fontSize:12, outline:"none", fontFamily:"inherit" }} />
                                </div>

                                <div style={{ display:"flex", gap:8 }}>
                                  <button onClick={() => {
                                    if (!reportDraft.report.trim()) return;
                                    const newReport = { ...reportDraft, id:"u"+Date.now(), city:trip.destination_city, date: new Date().toLocaleDateString("en-US",{month:"short", year:"numeric"}), author: reportDraft.author.trim() || "Anonymous" };
                                    setUserReports(p => [...p, newReport]);
                                    setReportForm(null);
                                  }} className="cta-btn"
                                    style={{ flex:1, padding:"11px", background:FOREST, color:CREAM, border:"none", fontSize:11, letterSpacing:"0.14em", textTransform:"uppercase", cursor:"pointer" }}>
                                    Submit Report
                                  </button>
                                  <button onClick={() => setReportForm(null)}
                                    style={{ padding:"11px 18px", background:"transparent", color:"#aaa", border:`1px solid ${RULE}`, fontSize:11, cursor:"pointer", letterSpacing:"0.08em" }}>
                                    Cancel
                                  </button>
                                </div>
                              </div>
