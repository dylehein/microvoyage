                          ...
                          {trip.nights > 0 ? (
                            ...
                            <>
                              ...
                              <div style={{ background:"rgba(255,255,255,0.025)", border:"1px solid rgba(255,255,255,0.06)", borderRadius:10, padding:"12px 14px", marginBottom:8 }}>
                                ...
                                <div style={{ display:"flex", gap:7, flexWrap:"wrap" }}>
                                  {[
                                    { name:"DayUse.com", icon:"🌞", color:"#f5c842", url:"https://www.dayuse.com/search?destination=" + encodeURIComponent(trip.destination_city), desc:"Book by the hour or half-day" },
                                    { name:"HotelsByDay", icon:"⏰", color:"#8ab4f8", url:"https://www.hotelsbyday.com/?q=" + encodeURIComponent(trip.destination_city), desc:"Day rates at top hotels" },
                                    { name:"ResortPass", icon:"🏊", color:"#7fc47f", url:"https://www.resortpass.com/search?destination=" + encodeURIComponent(trip.destination_city), desc:"Pool & spa day passes" },
                                  ].map(s => (
